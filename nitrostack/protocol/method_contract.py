...
MODERN_METHOD_CONTRACTS: tuple[MethodContract, ...] = (
    ...
    _contract("tools/list", requires_method_header=False),
    _contract("tools/call", name_field=NAME_FIELD_NAME, requires_method_header=False),
    _contract("notifications/tools/list_changed"),
    _contract("resources/list", requires_method_header=False),
    _contract("resources/templates/list", requires_method_header=False),
    ...
    _contract("prompts/list", requires_method_header=False),
